namespace Do_an_co_so
{
	partial class fDSDT
	{
		...
		private void InitializeComponent()
		{
			...
			this.contextMenuStripGiaHan = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.giaHạnToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.contextMenuStripTrangThai = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.hủyDựÁnToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.contextMenuStripGiaHan.SuspendLayout();
			this.contextMenuStripTrangThai.SuspendLayout();
			this.SuspendLayout();
			// 
			// dtgvDSDT
			// 
			...
			this.dtgvDSDT.Size = new System.Drawing.Size(1870, 448);
			...
			this.contextMenuStripAddMember.Size = new System.Drawing.Size(188, 52);
			...
			this.panel3.Size = new System.Drawing.Size(1912, 75);
			...
			this.panel1.Size = new System.Drawing.Size(1902, 176);
			...
			this.rdAll.Location = new System.Drawing.Point(1420, 13);
			...
			// rdGV
			// 
			this.rdGV.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.rdGV.Location = new System.Drawing.Point(1667, 13);
			this.rdGV.Name = "rdGV";
			...
			// rdSV
			// 
			this.rdSV.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.rdSV.Location = new System.Drawing.Point(1530, 14);
			this.rdSV.Name = "rdSV";
			...
			this.txtTimKiemTheoDeTai.Location = new System.Drawing.Point(250, 259);
			...
			this.txtTimKiemTheoDeTai.TextChanged += new System.EventHandler(this.txtTimKiemTheoDeTai_TextChanged);
			// 
			// contextMenuStripGiaHan
			// 
			this.contextMenuStripGiaHan.ImageScalingSize = new System.Drawing.Size(20, 20);
			this.contextMenuStripGiaHan.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.giaHạnToolStripMenuItem});
			this.contextMenuStripGiaHan.Name = "contextMenuStripGiaHan";
			this.contextMenuStripGiaHan.Size = new System.Drawing.Size(129, 28);
			this.contextMenuStripGiaHan.Opening += new System.ComponentModel.CancelEventHandler(this.contextMenuStripGiaHan_Opening);
			this.contextMenuStripGiaHan.ItemClicked += new System.Windows.Forms.ToolStripItemClickedEventHandler(this.contextMenuStripGiaHan_ItemClicked);
			// 
			// giaHạnToolStripMenuItem
			// 
			this.giaHạnToolStripMenuItem.Name = "giaHạnToolStripMenuItem";
			this.giaHạnToolStripMenuItem.Size = new System.Drawing.Size(128, 24);
			...
			// 
			// contextMenuStripTrangThai
			// 
			this.contextMenuStripTrangThai.ImageScalingSize = new System.Drawing.Size(20, 20);
			this.contextMenuStripTrangThai.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.hủyDựÁnToolStripMenuItem,
            this.hoànThànhToolStripMenuItem,
            this.tiếpTụcDựÁnToolStripMenuItem});
			this.contextMenuStripTrangThai.Name = "contextMenuStripTrangThai";
			this.contextMenuStripTrangThai.Size = new System.Drawing.Size(174, 76);
			this.contextMenuStripTrangThai.Opening += new System.ComponentModel.CancelEventHandler(this.contextMenuStripTrangThai_Opening);
			// 
			// hủyDựÁnToolStripMenuItem
			// 
			this.hủyDựÁnToolStripMenuItem.Name = "hủyDựÁnToolStripMenuItem";
			this.hủyDựÁnToolStripMenuItem.Size = new System.Drawing.Size(173, 24);
			this.hủyDựÁnToolStripMenuItem.Text = "Hủy dự án";
			this.hủyDựÁnToolStripMenuItem.Click += new System.EventHandler(this.hủyDựÁnToolStripMenuItem_Click);
			// 
			// hoànThànhToolStripMenuItem
			// 
			this.hoànThànhToolStripMenuItem.Name = "hoànThànhToolStripMenuItem";
			this.hoànThànhToolStripMenuItem.Size = new System.Drawing.Size(173, 24);
			...
			// 
			// tiếpTụcDựÁnToolStripMenuItem
			// 
			this.tiếpTụcDựÁnToolStripMenuItem.Name = "tiếpTụcDựÁnToolStripMenuItem";
			this.tiếpTụcDựÁnToolStripMenuItem.Size = new System.Drawing.Size(173, 24);
			this.tiếpTụcDựÁnToolStripMenuItem.Text = "Tiếp tục dự án";
			this.tiếpTụcDựÁnToolStripMenuItem.Click += new System.EventHandler(this.tiếpTụcDựÁnToolStripMenuItem_Click);
			// 
			// label6
			// 
			this.label6.AutoSize = true;
			this.label6.Font = new System.Drawing.Font("Microsoft Sans Serif", 16F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label6.Location = new System.Drawing.Point(11, 792);
			...
			this.contextMenuStripGiaHan.ResumeLayout(false);
			this.contextMenuStripTrangThai.ResumeLayout(false);
		...
		private System.Windows.Forms.ContextMenuStrip contextMenuStripGiaHan;
		private System.Windows.Forms.ToolStripMenuItem giaHạnToolStripMenuItem;
		private System.Windows.Forms.ContextMenuStrip contextMenuStripTrangThai;
		private System.Windows.Forms.ToolStripMenuItem hủyDựÁnToolStripMenuItem;
